...
const styles = StyleSheet.create({
  ...
  segmentOuter: {
    ...
    height: 36, marginBottom: 16, padding: 2, position: "relative",
    borderWidth: 1, borderColor: "rgba(255,255,255,0.06)",
  },
  segmentIndicator: {
    position: "absolute", top: 2, height: 32, backgroundColor: "rgba(255,255,255,0.12)",
    borderRadius: 8,
  },
  segmentBtn: { flex: 1, justifyContent: "center", alignItems: "center", zIndex: 1, minHeight: 36 },
  segmentText: { color: "rgba(235,235,245,0.4)", fontSize: 13, fontWeight: "600", letterSpacing: -0.3 },
  segmentActive: { color: "#FFFFFF" },
  chartCard: {
    backgroundColor: "rgba(28,28,30,0.8)", borderRadius: 20, padding: 16, marginVertical: 6,
    borderWidth: 1, borderColor: "rgba(255,255,255,0.06)",
  },
  ...
  summaryCard: {
    flex: 1, backgroundColor: "rgba(28,28,30,0.8)", borderRadius: 12, paddingVertical: 14,
    alignItems: "center", minHeight: 44, borderWidth: 1, borderColor: "rgba(255,255,255,0.06)",
  },
